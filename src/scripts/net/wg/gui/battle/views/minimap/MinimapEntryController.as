package net.wg.gui.battle.views.minimap
{
   ...
   public class MinimapEntryController implements IDisposable
   {
      ...
      {
         var _loc2_:int = int(this._nonScalableEntries.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      {
         var _loc3_:int = int(this._scalableEntries.indexOf(param1));
         if(_loc3_ != -1)
         {
         ...
         if(param2)
         {
            _loc3_ = int(this._scalableEntriesWithNonScaleContent.indexOf(param1));
            if(_loc3_ != -1)
            {
      ...
      {
         this.verifyIsDisposed();
         var _loc2_:int = int(this._vehicleEntries.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      {
         this.verifyIsDisposed();
         var _loc2_:int = int(this._vehicleLabelsEntries.indexOf(param1));
         if(_loc2_ != -1)
         {
