...
from altminimapvehiclenames.settings import createFolderSafely, getDefaultConfigTokens, ConfigException
from altminimapvehiclenames.settings.config_template import CONFIG_TEMPLATE

logger = logging.getLogger(__name__)

CONFIG_FILE_DIR = os.path.join('mods', 'configs', 'AltMinimapVehiclenames')
